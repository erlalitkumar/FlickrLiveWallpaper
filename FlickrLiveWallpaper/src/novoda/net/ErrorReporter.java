...
/*
 * I want to use this in a future version.
 * Thanks to:
...
public class ErrorReporter implements Thread.UncaughtExceptionHandler {
    ...
    private void SendErrorMail(Context _context, String ErrorContent) {
        ...
        String subject = _context.getResources().getString(R.string.crash_reporter_mail_subject);
        String body = _context.getResources().getString(R.string.crash_reporter_mail_body) + "\n\n"
                + ErrorContent + "\n\n";
        sendIntent.putExtra(Intent.EXTRA_EMAIL, new String[] {
            "postmaster@alocaly.com"
        });
    ...
    public void CheckErrorAndSendMail(Context _context) {
        try {
            ...
            if (bIsThereAnyErrorFile()) {
                ...
                // on limite ˆ N le nombre d'envois de rapports ( car trop lent
                // )
